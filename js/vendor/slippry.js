...
(function ($) {
  ...
  defaults = {
    ...
    // options
    adaptiveHeight: false, // ***** DISABLED TO AVOID CHANGES IN LAYOUT FOR VARIED SIZE IMG
    start: 1, // num (starting from 1), random
    loop: true, // first -> last & last -> first arrows
    captionsSrc: 'img', // img, el [img takes caption from alt or title, el from title of slide element]
    captions: false, // Position: overlay, below, custom, false ******* TURNED CAPTIONS OFF BECAUSE THEY LOOKED TACKY
    ...
    // pager
    pager: false, //***** TOOK OUT CONTROLS ON HOME PAGE
    pagerClass: 'sy-pager',

    // controls
    controls: false, //***** TOOK OUT CONTROLS ON HOME PAGE
    ...
    speed: 1200, // time the transition takes (ms)
